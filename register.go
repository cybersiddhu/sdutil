...
func (cmd *register) RegisterAttributesWithExitHook(name, port string, attributes multivalue, verbose bool) {
    ...
    cmd.client.RegisterWithAttributes(name, *cmd.host+":"+port, amap)
}
